...
#define NAME "D:\\Documents\\programming\\bram_playground\\frame_dropper\\12-out.mp4"
#define OUT_NAME "D:\\Documents\\programming\\bram_playground\\motion_interpolator\\x64\\Debug\\12-out-extended.mp4" 
#define NUM_INTERP 8
	...
	for (;;)
	{
		...
		if (prevframe.data)
		{
			...
			for (int t = 0; t < NUM_INTERP; t++)     // interpolating 20 frames from two given frames at different time locations
			{
				...
				cout << "numframe processed :" << ++numofframe <<endl;
