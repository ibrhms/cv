...
def face_clustering(pre_path, face_rec_path, in_path, out_path):
    # if len(sys.argv) != 5:
    #     print(
    ...
    predictor_path = pre_path
    face_rec_model_path = face_rec_path
    faces_folder_path = in_path
    ...
    file_list = glob.glob(os.path.join(faces_folder_path, "*.png"))
    num_of_files = len(file_list)
    #print("num of file: {}".format(num_of_files))
    for f in file_list:
        ...
        num_of_files -= 1
        print("files left :{}".format(num_of_files))
    ...
    # Find the indices for the each class
    ...
    #     output_folder_path = out_path +"_"+ str(idx)
    ...
    #         dlib.save_image(img,file_path+".png")
