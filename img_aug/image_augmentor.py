...
class Skew(Operation):
    def __init__(self,  skew_type, magnitude):
    ...
    def perform_operation(self, image):
        ...
        # This requires that all ground truth image in the list
...
class Flip(Operation):
    def __init__(self, top_bottom_left_right):
        Operation.__init__(self)
...
class RandomBrightness(Operation):
    ...
    def perform_operation(self, image):      
        ...
        return image_enhancer_brightness.enhance(self.getFactor())
